...
function FormPanel() {
  return (
    <Fragment>
      <p className="flex items-center gap-8 text-muted mb-24">
  ...
  return (
    <div>
      <ProgressBar
        ...
        label={
          <Trans
            message="Importing title :number of :total"
            values={{number: data.currentItem, total: data.totalItems}}
          />
        }
      />
      <div className="mt-24 h-400 overflow-auto compact-scrollbar text-xs">
...
function PaginationFields() {
  return (
    <div className="mb-24">
      ...
      <p className="text-xs text-muted pt-10">
